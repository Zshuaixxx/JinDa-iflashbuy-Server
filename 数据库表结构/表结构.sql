...
CREATE TABLE `address_book` (
  ...
  `location` varchar(30) COLLATE utf8mb3_bin NOT NULL COMMENT '经纬度（var30）',
  `adcode` varchar(10) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '行政区规划编码（var10）',
  PRIMARY KEY (`id`)
...
CREATE TABLE `admin_login_log` (
  ...
  `admin_id` int NOT NULL COMMENT '管理员id 逻辑外键',
  `login_time` datetime NOT NULL COMMENT '登录时间',
  `login_ip` varchar(45) NOT NULL COMMENT '登录ip',
  `device_info` varchar(255) NOT NULL COMMENT '登录设备信息',
  `login_status` tinyint(1) NOT NULL COMMENT '登录是否成功',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='管理端登录日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='菜品及套餐分类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dish_flavor` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=138 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='菜品口味关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `operate_log` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '主键id(int)',
  `employee_id` mediumtext NOT NULL COMMENT '操作员工id(long)',
  `operate_time` datetime DEFAULT NULL COMMENT '操作时间(datetime)',
  `operate_class` varchar(50) DEFAULT NULL COMMENT '操作类(var50)',
  `operate_method` varchar(100) DEFAULT NULL COMMENT '操作方法(var100)',
  `method_params` varchar(1000) DEFAULT NULL COMMENT '操作方法参数(var1000)',
  `method_result` varchar(200) DEFAULT NULL COMMENT '操作方法返回(var200)',
  `cost_time` int DEFAULT NULL COMMENT '操作花费时间(int)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=145 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='操作日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `order_detail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=150 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='订单明细表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  `rider_id` mediumtext COLLATE utf8mb3_bin COMMENT '接单骑手id(long)',
  `delivery_proof` varchar(100) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '送达凭证(var100)',
  `version` int DEFAULT NULL COMMENT '乐观锁版本号（int）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=104 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='订单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `rider` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键id（bigint）',
  `phone` varchar(15) DEFAULT NULL COMMENT '手机号 账号 (var15)',
  `password` varchar(64) DEFAULT NULL COMMENT '加密密码（var64）',
  `openid` varchar(100) DEFAULT NULL COMMENT '微信登录凭证(var100)',
  `register_time` datetime DEFAULT NULL COMMENT '注册时间（datetime）',
  `sex` varchar(2) DEFAULT NULL COMMENT '性别（var2）0未知 1男 1女',
  `avatar` varchar(300) DEFAULT NULL COMMENT '头像（var300）',
  `name` varchar(20) DEFAULT NULL COMMENT '骑手名称（var20）',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='骑手表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='套餐';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `setmeal_dish` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=118 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='套餐菜品关系';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `shopping_cart` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=183 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='购物车';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-04-07 23:19:58
